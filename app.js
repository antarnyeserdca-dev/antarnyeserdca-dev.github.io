const proposals = [
  ...
  {
    id: "07",
    label: "Масштаб и доверие",
    title: "Карта строек по России",
    summary:
      "Интерактивная карта показывает географию компании: активные стройки, завершённые дома и количество клиентов в разных регионах России. Каждую точку можно открыть, чтобы увидеть фото объекта и текущий этап работ — реальное подтверждение масштаба и доверия к компании.",
    details: [
      "Активные стройки",
      "Завершённые дома",
      "География клиентов",
